    ...
    () => [
      {
        id: 'hero-logo',
        titleTop: 'AI Logo',
        title: 'Kendi Kişisel Logonuzu Oluşturun',
        badgeNew: true,
      },
      {
        id: 'hero-sticker',
        titleTop: 'AI Sticker Tasarımı',
        title: 'Kendi Sticker Tasarımını Oluştur',
        badgeNew: true,
      },
      {
        id: 'poster',
        titleTop: 'Yapay Zeka Posteri',
        title: 'Kendi Posterinizi Oluşturun',
        badgeNew: true,
      },
      {
        id: 'post',
        titleTop: 'Yapay Zeka Gönderisi',
        title: 'Kendi Postunu Oluştur',
        badgeNew: true,
      },
      {
        id: 'room',
        titleTop: 'Yapay Zeka Oda Tasarımı',
        title: 'Odanı Dönüştür',
        badgeNew: true,
      },
      {
        id: 'book',
        titleTop: 'Yapay Zeka Kitap Kapağı',
        title: 'Kendi Kitap Kapağını Oluştur',
        badgeNew: true,
      },
      {
        id: 'avatar',
        titleTop: 'Yapay Zeka Küçük Görseli',
        title: 'Kendi Küçük Resmini Oluştur',
        badgeNew: true,
      },
      {
        id: 'wall',
        titleTop: 'AI Duvar Kağıdı',
        title: 'Kendi Duvar Kağıdınızı Oluşturun',
        badgeNew: true,
      },
      {
        id: 'invite',
        titleTop: 'Yapay Zeka Davetiyesi',
        title: 'Kendi Davetiyeni Oluştur',
        badgeNew: true,
      },
      {
        id: 'coloring',
        titleTop: 'Yapay Zeka Boyama Kitabı',
        title: 'Kendi Boyama Sayfanı Oluştur',
        badgeNew: true,
      },
      {
        id: 'car',
        titleTop: 'AI Araba Tasarımı',
        title: 'Kendi Araba Tasarımını Oluştur',
        badgeNew: true,
      },
      {
        id: 'tattoo',
        titleTop: 'AI Dövme',
        title: 'Kendi Dövmenizi Tasarlayın',
        badgeNew: true,
      },
      {
        id: 'card',
        titleTop: 'Yapay Zeka Kartı',
        title: 'Kendi Kartını Oluştur',
        badgeNew: true,
      },
      {
        id: 'signature',
        titleTop: 'AI İmza',
        title: 'Kendi İmzanızı Oluşturun',
        badgeNew: true,
      },
      {
        id: 'mockup',
        titleTop: 'AI Maket',
        title: 'Kendi Maketinizi Oluşturun',
        badgeNew: true,
      },
      {
        id: 'clothes',
        titleTop: 'AI Giysi',
        title: 'Kendi Giysinizi Tasarlayın',
        badgeNew: true,
      },
      {
        id: 'sticker',
      ...
      },
      {
        ...
        title: 'Kendi Ürün Fotoğraf & Videonu Oluştur',
        badgeNew: true,
      },
      {
        id: 'album',
        titleTop: 'Yapay Zeka Albüm Kapağı',
        title: 'Kendi Albüm Kapağını Oluştur',
        badgeNew: true,
      },
      {
        id: 'art',
        titleTop: 'Yapay Zeka Sanatı',
        title: 'Muhteşem AI Sanatı Oluşturun',
        badgeNew: true,
      },
      {
        id: 'garden',
        titleTop: 'AI Bahçe Tasarımı',
        title: 'Kendi Bahçe Tasarımını Oluştur',
        badgeNew: true,
      },
      {
        id: 'logo',
